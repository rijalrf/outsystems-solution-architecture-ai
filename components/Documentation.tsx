    ...
    return (
        <div className="bg-sky-50 dark:bg-sky-900/20 p-5 rounded-xl border border-sky-200 dark:border-sky-500/30 mb-8">
            <div className="flex items-start">
                ...
                <div>
                    <h3 className="text-lg font-bold text-sky-800 dark:text-sky-200">{t('docs.title')}</h3>
                    ...
                    <ol className="list-decimal list-inside text-sm space-y-1 text-sky-600 dark:text-sky-400">
                        <li>{t('docs.step1')}</li>
                        <li>{t('docs.step2.text')} <span className="font-semibold">{t('docs.step2.command')}</span></li>
                        <li>{t('docs.step3')}</li>
                        <li>{t('docs.step4')}</li>
                    </ol>
                </div>
